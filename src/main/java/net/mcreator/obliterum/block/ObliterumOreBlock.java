...
public class ObliterumOreBlock extends ObliterumModElements.ModElement {
	@ObjectHolder("obliterum:obliterum_ore")
	public static final Block block = null;
	public ObliterumOreBlock(ObliterumModElements instance) {
		super(instance, 2);
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(ObliterumOreBlock.block, (int) (1)));
		}
	}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("obliterum:obliterum_ore_match"), () -> CustomRuleTest.codec);
