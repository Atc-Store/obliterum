...
public class EnlightenmentProcedureProcedure extends ObliterumModElements.ModElement {
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if (((EnchantmentHelper.getEnchantmentLevel(EnlightenmentEnchantment.enchantment,
				((sourceentity instanceof LivingEntity) ? ((LivingEntity) sourceentity).getHeldItemOffhand() : ItemStack.EMPTY))) == 1)) {
			if (world instanceof World && !world.isRemote()) {
				((World) world).addEntity(new ExperienceOrbEntity(((World) world), x, y, z, (int) Math.pow(10, 2)));
			}
		}
		if (((EnchantmentHelper.getEnchantmentLevel(EnlightenmentEnchantment.enchantment,
				((sourceentity instanceof LivingEntity) ? ((LivingEntity) sourceentity).getHeldItemOffhand() : ItemStack.EMPTY))) == 2)) {
			if (world instanceof World && !world.isRemote()) {
				((World) world).addEntity(new ExperienceOrbEntity(((World) world), x, y, z, (int) Math.pow(10, 2.3)));
			}
		}
		if (((EnchantmentHelper.getEnchantmentLevel(EnlightenmentEnchantment.enchantment,
				((sourceentity instanceof LivingEntity) ? ((LivingEntity) sourceentity).getHeldItemOffhand() : ItemStack.EMPTY))) == 3)) {
			if (world instanceof World && !world.isRemote()) {
				((World) world).addEntity(new ExperienceOrbEntity(((World) world), x, y, z, (int) Math.pow(10, 2.5)));
			}
		}
		if (((EnchantmentHelper.getEnchantmentLevel(EnlightenmentEnchantment.enchantment,
				((sourceentity instanceof LivingEntity) ? ((LivingEntity) sourceentity).getHeldItemOffhand() : ItemStack.EMPTY))) == 4)) {
			if (world instanceof World && !world.isRemote()) {
				((World) world).addEntity(new ExperienceOrbEntity(((World) world), x, y, z, (int) Math.pow(10, 2.9)));
			}
		}
		if (((EnchantmentHelper.getEnchantmentLevel(EnlightenmentEnchantment.enchantment,
				((sourceentity instanceof LivingEntity) ? ((LivingEntity) sourceentity).getHeldItemOffhand() : ItemStack.EMPTY))) == 5)) {
			if (world instanceof World && !world.isRemote()) {
